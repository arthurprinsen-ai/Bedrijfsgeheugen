...
- Protected `main` is currently healthy on `374d6b1dae19290b3bc1560fb0c44f08ba50965d`, while older open issues still state that main protection is absent.
