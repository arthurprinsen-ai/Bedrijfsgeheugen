...
## 2026-08-30 — IMPROVEMENT — Brain-wide 10.000-credit cost control and internal dashboard
- **Fingerprint:** `brain-cost-control|monthly-10000|dashboard-v1`
- **Root cause:** Make-scenario’s en agents misten één afdwingbare gedeelde maandgrens, volledige automatische inventory en een veilige genormaliseerde cost-per-outcome-weergave. BG159 verrijkte bovendien iedere herhaalde dagelijkse run opnieuw, waardoor dezelfde dag onnodig extra credits, operations en latency ontstonden.
- **Change:** één deterministische 10.000-credit policy, Amsterdam-kalenderdagruimte, automatische scenario- en agentcatalogus, deduplicerende kostenledger, maximaal één veilige optimalisatie per dag, Brain-event-routing, outcome obligations en een read-only intern dashboard achter server-side `powerhouse-cost-admin`-autorisatie. Nieuwe onbekende optionele componenten starten fail-closed als `UNCLASSIFIED` / `BUDGET_DEFERRED`.
- **Make before/after:** BG159 repeat-path vóór wijziging: 17 credits, 13 operations, 441.055 bytes en 13.377 ms. Canary `6db5901a393240e1a053ff4416c28d78`: 6 credits, 4 operations, 382.077 bytes en 4.633 ms; respectievelijk 64,7%, 69,2%, 13,4% en 65,4% lager. Volledige catalogus/budget-canary `70cfb1adc37e4cf3b1b488eaf403ec6f` bleef groen met 6 credits, 4 operations, 462.251 bytes en 6.667 ms.
- **Shared memory:** BG168 `e4511c33ffd8411a951948a6d9f62545` dispatchte het outcome; BG166 `a73b2e424f104f47a352ee872fb9838c` bleef groen; BG167 `65532e7e821049d5b5d373adf0e654bd` bevestigde fingerprint `make:7132648|daily-repeat-enrichment|2026-08-30` onder `TEAM-CONTRACT-v1.5-BRAIN-MISSIONS`.
- **Security:** dashboardroute en API zijn no-store/noindex, read-only en fail-closed; alleen geaggregeerde data. Invite-only Identity en roltoekenning blijven een expliciete menselijke permissiegrens.
