...
Follow-up: corrected Composio v3.1 proxy base construction after production readback exposed the invalid `backend.composio.dev.1` URL. Same recovery obligation, no provider side effect.
