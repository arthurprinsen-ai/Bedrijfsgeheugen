...
- Alle lessons in de append-only current-execution shard worden automatisch gecontroleerd op een expliciet `preventionRule`-veld en een actieve overeenkomstige rule.
- Bij moving-main overlap op de prevention registry wordt een stale candidate gesloten en opnieuw vanaf actuele main opgebouwd, zodat parallelle lessons/rules behouden blijven.
