...
Canonical replay authority: `tests/brain-delivery-hygiene-candidate-type-closure.test.mjs` is the historical replay and canary binding used by the learning evaluator; the lower-level `tests/delivery-hygiene-policy.test.mjs` remains the direct parser/admission regression.
