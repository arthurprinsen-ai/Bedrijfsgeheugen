...
- [x] Original PR #1632 built and verified before moving-main conflict.
- [x] Rebase-by-successor strategy selected after `main` advanced; no force-update or branch-protection bypass.
- [ ] Verify all required CI/gates on the exact successor head.
