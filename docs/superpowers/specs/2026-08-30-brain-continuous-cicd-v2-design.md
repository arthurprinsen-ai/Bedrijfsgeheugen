...
4. Only real merge conflicts, changed-path overlap, or declared dependency conflicts force synchronization.
...
7. current-main conflict and declared-dependency gate;
