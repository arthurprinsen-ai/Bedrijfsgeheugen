export const POWERHOUSE_SYSTEM_MAP = Object.freeze({
  ...
  inventories:Object.freeze({
    ...
    supabaseFunctions:Object.freeze(["bg-analytics-sync-composio","bg-buffer-sync","bg-dagoverzicht","bg-ga4-sync","bg-notion-sync","bg-opdrachtenradar","bg-pre-publish-review","brain-operating-authority","brain-runtime-metric-ingest","commercial-lead-ingest","content-operations","growth-datahub-ingest","portal-state-eu","powerhouse-composio-instagram-setup","powerhouse-composio-linkedin-setup","powerhouse-content-loop","powerhouse-content-orchestrator","powerhouse-dataforseo-intelligence","powerhouse-forecast-calibrator","powerhouse-instagram-media-router","powerhouse-instagram-media-verifier","powerhouse-meta-instagram-setup","powerhouse-predictive-engine","powerhouse-revenue-intelligence","powerhouse-runtime","powerhouse-seo-opportunity-resolver","powerhouse-system-map-inventory","powerhouse-scan-ingest","powerhouse-social-publisher","resource-usage-eu","revenue-learning-store","social-learning-store"]),
    skills:Object.freeze(["instagram-composio-publisher","linkedin-composio-publisher","personal-linkedin-life-only","powerhouse-browser-gate-boundedness","powerhouse-continuity","powerhouse-development-integration","powerhouse-delivery-concurrency","powerhouse-delivery-self-optimization","powerhouse-resource-sustainability","powerhouse-toolchain-authority","seo-revenue-growth","trigger-based-mkb-acquisition"]),
  ...
  providerSnapshot:Object.freeze({
    ...
    github:Object.freeze({workflows:114,skills:12,agentFabricModules:8}),
  ...
  developmentIntegrationContract:Object.freeze({
    fingerprint:'development|whole-brain-portal-skill-integration|v1',
    rule:'Every material development change is a Whole Brain change: analyze cross-layer impact, register structural relations, project contextually to Portal V2 when relevant, and propagate reusable learning through deterministic skill projection.',
    brainImpactLayers:Object.freeze(['evidence','knowledge','graph','semantics','signals','prediction','impact','decision','agents','delivery','learning','governance','resource']),
    portalDefault:'PROJECT_CONTEXTUALLY_WHEN_USER_OR_OPERATOR_RELEVANT',
    noPortalSurface:'NO_PORTAL_SURFACE_REQUIRES_REASON',
    skillProjectionRequired:true,
    terminalRequires:Object.freeze(['system-map-readback','portal-readback-or-no-surface','production-readback','outcome-value','learning-prevention','skill-projection'])
  }),
