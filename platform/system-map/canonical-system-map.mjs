export const POWERHOUSE_SYSTEM_MAP = Object.freeze({
  ...
  inventories:Object.freeze({
    ...
    skills:Object.freeze(["instagram-composio-publisher","personal-linkedin-life-only","powerhouse-continuity","powerhouse-delivery-concurrency","powerhouse-delivery-self-optimization","powerhouse-resource-sustainability","powerhouse-toolchain-authority","seo-revenue-growth","trigger-based-mkb-acquisition"]),
