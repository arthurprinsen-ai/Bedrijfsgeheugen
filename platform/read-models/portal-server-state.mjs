...
const ALLOWED_KEYS=Object.freeze(['company','period','managementSummary','healthCards','roadmap','recommendedActions','monthlyImpact','activities','integrationStatus','quickLinks','graph','signals','decisions','actions','valueItems','memories','agents','audit','admin','legacyInputs','sourceMeta','dataAiPassport']);
