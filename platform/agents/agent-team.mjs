...
export const DEFAULT_AGENT_TEAM = Object.freeze([
  Object.freeze({
    ...
    playbooks:['self-heal-safe-failure','retry-fallback-last-known-good','production-regression-recovery','portal-v2-empty-state-surface-preservation'],
    learningContracts:[...sharedLearning,'reliability.v1','portal-v2-parity.v1'],
  }),
  Object.freeze({
    id:'agent-security',
  ...
  Object.freeze({
    ...
    playbooks:['source-projection-reconciliation','schema-drift-recovery','data-quality-regression','portal-v2-empty-state-surface-preservation'],
    learningContracts:[...sharedLearning,'data-quality.v1','portal-v2-parity.v1'],
  }),
  Object.freeze({
    id:'agent-website-ux',
    domains:['Website','UX'],
    ...
    playbooks:['ux-regression-recovery','conversion-friction-reduction','responsive-interface-verification','portal-v2-empty-state-surface-preservation'],
    learningContracts:[...sharedLearning,'ux.v1','portal-v2-parity.v1'],
  }),
  Object.freeze({
