...
const NATIVE_LEGACY_WORKSPACES=new Set(['profiel','dataai','antwoorden','aiscan','business','cijfers','mensen','wijzigingen','advies','branche','onderzoek','strategie','bijhouden','roadmap','canvassen','dd','eindconclusie','waarde','beleid','aicap','dna','downloaden','afdrukken','openen','invoeren']);
