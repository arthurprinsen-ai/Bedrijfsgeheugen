...
const records=[
  ...
  normalizeBrainRecord({...base,type:'Outcome',id:'O1',predecessorIds:['V1'],executed:true,verified:true,result:'verified runtime result',payload:{}}),
  normalizeBrainRecord({...base,type:'Value',id:'VAL1',predecessorIds:['O1'],executed:true,verified:true,result:'100 EUR',payload:{realised:true}}),
