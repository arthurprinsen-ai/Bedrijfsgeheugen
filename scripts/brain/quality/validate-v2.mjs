...
for(const required of ['contract_test','validator','core','coverage','exploration_policy','adversarial_matrix','production_shadow','test_economics','surface_registry']) if(!c.implementation?.[required]) gaps.push(`implementation:${required}`);
