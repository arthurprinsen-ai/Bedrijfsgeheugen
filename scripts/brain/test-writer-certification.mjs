...
// Historical certification evidence remains immutable; current obligations use the
// supported Powerhouse/Supabase shared-memory path and keep BG168/BG167 as retired provenance.
...
console.log('PASS writer certification readiness distinguishes historical proof from current Powerhouse shared-memory truth');