...
const VIDEO_TAG = `<video id="heroBackgroundVideo" class="hero-bg-video" autoplay muted playsinline loop preload="metadata" poster="/assets/inspirational-hero-v1.svg" aria-hidden="true">
  ...
  try {
    ...
    return {
      ...
      headers: {
        ...
        'X-Prototype-Version': 'v18-inspirational-hero-v1'
      },
      body: html
    };
  } catch (error) {
