...
const SPECIALISTS=Object.freeze({
  ...
  'model-bcg':Object.freeze({id:'model-bcg',legacyCapability:'bcg',mode:'workspace',schemaVersion:1,renderer:'bcg',dataSlice:'portal.portfolio',validators:Object.freeze(['canonical-state','evidence-required','numeric-inputs']),calculators:Object.freeze(['bcg-quadrant-classification']),dependencies:Object.freeze(['modellen','businesscase','roadmap']),completionRules:Object.freeze(['runtime-evidence','server-confirmed-state']),browserContract})
});
