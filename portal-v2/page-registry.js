...
export const PORTAL_SECTIONS = Object.freeze({
  ...
  besturen: { label: 'Besturen', pages: ['profiel','strategie-naar-maandagochtend','strategiemodellen','canvassen','eindconclusie','roadmap','strategy-dna','modellen','model-bcg','kansenkaart','businesscase','ai-scan','os:impact-engine','os:scenario-simulator','os:next-best-actions'] },
