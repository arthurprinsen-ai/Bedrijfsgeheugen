...
export const PORTAL_SECTIONS = Object.freeze({
  ...
  besturen: { label: 'Besturen', pages: ['profiel','bedrijfssituatie','strategie-naar-maandagochtend','strategiemodellen','canvassen','eindconclusie','roadmap','strategy-dna','modellen','model-bcg','kansenkaart','businesscase','ai-scan','os:impact-engine','os:scenario-simulator','os:next-best-actions'] },
  ...
  'data-intelligence': { label: 'Data & intelligence', pages: ['data-ai','cijfers-maatstaven','koppelingen','brain-verwerking','ai-capabilities','data-ai-passport','trust-center','datahubstatus','agentstatus','powerhouse-control-center','rekenwijze','onderzoek','branche-markt','os:evidence-health','os:capability-graph'] },
  'actueel-externe-data': { label: 'Actueel & externe data', pages: ['ondernemersdata','wet-regelgeving','arbeidsmarkt-personeel','subsidies-regelingen','economie-branche-actueel','ai-technologie-actueel','deadlines','bronnenbibliotheek','bronnenstatus'] },
  ...
  overig: { label: 'Overig', pages: ['due-diligence','exit','portfolio-control','herstel-continuiteit','waarde-financiering'] }
});

const PAGE_META = {
  overzicht:{label:'Overzicht'}, profiel:{label:'Profiel per onderdeel'}, bedrijfssituatie:{label:'Bedrijfssituatie & context'}, 'data-ai':{label:'Data en AI'}, 'ai-scan':{label:'AI-scan: kansenkaart'}, kansenkaart:{label:'Kansenkaart'}, 'csrd-impact':{label:'CSRD & Impact'}, 'gegevens-invullen':{label:'Je gegevens invullen'}, 'ingevulde-gegevens':{label:'Wat je hebt ingevuld'}, businesscase:{label:'Businesscase'},
  'cijfers-maatstaven':{label:'Cijfers en maatstaven'}, 'waarde-financiering':{label:'Waarde en financiering'}, mensen:{label:'Mensen'}, 'branche-markt':{label:'Branche en markt'}, onderzoek:{label:'Onderzoek'}, 'compliance-governance':{label:'Compliance, security en governance'}, 'compliance-command-center':{label:'Compliance Command Center'}, 'ai-capabilities':{label:'AI-capabilities'}, 'data-ai-passport':{label:'Data & AI Passport'}, 'trust-center':{label:'AI Trust Center'}, 'eu-ai-act-audit':{label:'EU AI Act auditrapport'}, 'rekenwijze':{label:'Hoe dit portaal rekent'},
  'strategy-dna':{label:'Strategy DNA'}, strategiemodellen:{label:'Strategiemodellen'}, modellen:{label:'Alle modellen'}, 'model-bcg':{label:'BCG-matrix'}, canvassen:{label:'Canvassen'}, eindconclusie:{label:'De eindconclusie'}, 'due-diligence':{label:'Due diligence'}, exit:{label:'Exit'}, 'portfolio-control':{label:'Portfolio Control'}, 'herstel-continuiteit':{label:'Herstel & continuïteit'},
  ...
  ondernemersdata:{label:'Actueel & externe data'}, 'wet-regelgeving':{label:'Wet- & regelgeving'}, 'arbeidsmarkt-personeel':{label:'Arbeidsmarkt & personeel'}, 'subsidies-regelingen':{label:'Subsidies & regelingen'}, 'economie-branche-actueel':{label:'Economie & branche'}, 'ai-technologie-actueel':{label:'AI & technologie'}, deadlines:{label:'Deadlines'}, bronnenbibliotheek:{label:'Bronnenbibliotheek'}, bronnenstatus:{label:'Bronnenstatus'}, datahubstatus:{label:'Datahubstatus'}, 'brain-verwerking':{label:'Brain-verwerking'}, agentstatus:{label:'Agentstatus'}, 'powerhouse-control-center':{label:'Powerhouse Control Center'}, 'actieve-acties':{label:'Actieve acties'}, 'recovery-obligations':{label:'Open recovery obligations'}, 'outcomes-evidence':{label:'Outcomes & evidence'}, 'learning-writeback':{label:'Learning/writeback'}, 'self-heal':{label:'Self-heal / recovery'}, audittrail:{label:'Audittrail'},
