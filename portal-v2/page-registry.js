...
export const PORTAL_SECTIONS = Object.freeze({
  ...
  'data-intelligence': { label: 'Data & intelligence', pages: ['data-ai','cijfers-maatstaven','koppelingen','brain-verwerking','ai-capabilities','data-ai-passport','datahubstatus','agentstatus','powerhouse-control-center','rekenwijze','onderzoek','branche-markt','os:evidence-health','os:capability-graph'] },
