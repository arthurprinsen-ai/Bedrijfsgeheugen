...
function cijfers(state){
 ...
 return [
  ...
  section('Klanttevredenheid (KTO)',[['NPS',has(m.nps)?String(m.nps):'Nog niet ingevuld'],['Tevredenheid',has(m.satisfaction)?pct(m.satisfaction):'Nog niet ingevuld'],['Klachten',has(m.complaints)?String(m.complaints):'Nog niet ingevuld']]),
