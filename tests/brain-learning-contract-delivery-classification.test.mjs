...
test('chat-learning, Make agent and Netlify preview guard tests are classified as backend governance work', () => {
  for (const path of [
    ...
    'tests/netlify-preview-impact-future-contract.test.mjs'
  ]) {
