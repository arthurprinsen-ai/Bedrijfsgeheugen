...
test('AI ecosystem public copy is covered by canonical immutable English cache contract', async () => {
  const [patchRaw,builder,netlify] = await Promise.all([
  ...
  assert.match(builder,/config','bg-static-i18n-en\.json/);
