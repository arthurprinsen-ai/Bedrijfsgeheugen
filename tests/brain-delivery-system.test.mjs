...
test('blog content is classified as website delivery work', async () => {
  const policy = JSON.parse(await readFile('config/brain-delivery-system.json', 'utf8'));
  const plan = createDeliveryPlan({ changedPaths:['blog/writer-verification-weekblog-123/index.html'], headSha:'feedface12345678', policy });
