...
assert.match(builder, /https:\/\/adhjwmvyoixzjtmiroln\.supabase\.co\/storage\/v1\/object\/public\/media\/hero\/shanghai-v2\.mp4/, 'production must use the explicitly accepted 10-second Supabase hero asset');
