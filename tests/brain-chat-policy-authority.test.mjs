...
test('one canonical chat-to-Brain policy owns semantics and the guard is enforcement projection only', async () => {
...
test('PR lifecycle mutations require fresh authoritative PR readback', async () => {
