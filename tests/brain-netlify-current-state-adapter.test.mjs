...
test('maps successful Netlify deploy evidence into canonical CurrentState input',()=>{
  const input=createNetlifyCurrentStateInput({tenantId:'tenant-a',siteId:'site-123',deployId:'deploy-456',commitRef:'abc123',siteName:'bedrijfsgeheugen',deployState:'ready',publishedAt:'2026-08-30T18:32:41Z',deployUrl:'https://example.netlify.app'});
