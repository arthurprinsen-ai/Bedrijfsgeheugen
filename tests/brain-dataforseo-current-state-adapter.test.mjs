...
test('maps completed DataForSEO task evidence into canonical CurrentState input',()=>{
  const input=createDataForSeoCurrentStateInput({tenantId:'tenant-a',taskId:'task-123',keyword:'bedrijfsgeheugen',locationCode:'2528',taskState:'completed',observedAt:'2026-08-30T18:40:00Z',resultCount:100});
