...
test('de toestemmingslaag injecteert geen eigen hero meer', () => {
  assert.doesNotMatch(CONSENT_JS, /function initMoneyPage|hydrateExistingHero/,
    'de money-page laag is terug; die vecht met de hero die de canonieke schil al levert');
  assert.ok(CONSENT_JS.length < 4000,
    'assets/stijl.js draagt weer meer dan de toestemmingslaag');
});
