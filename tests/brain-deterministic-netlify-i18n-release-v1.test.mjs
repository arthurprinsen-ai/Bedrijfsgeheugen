...
test('production and preview builds are deterministic and production requires the versioned English cache', () => {
  ...
  assert.match(localized,/TRANSLATION_CACHE_PATCH_DIR/);
});
