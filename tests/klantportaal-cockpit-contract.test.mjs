...
test('nieuwe shell mount een volledige portalbibliotheek en iframe workspace',()=>{assert.ok(js.includes("id='legacyWorkspace'"));assert.ok(js.includes("id=\"fullPortalNav\""));assert.ok(js.includes("id=\"legacyFrame\""));assert.ok(js.includes('1-op-1 bestaande inhoud'))});
