...
import {renderProjectTrace} from '../portal-next/portal-project-views.js';
...
test('trace activeert alleen evidence-backed runtimefasen',()=>{
  const html=renderProjectTrace({flow:{source:{status:'verified'},datahub:{status:'verified'},brain:{status:'waiting'},powerhouse:[],module:null,action:null,outcome:null,learning:{status:'idle'}}});
