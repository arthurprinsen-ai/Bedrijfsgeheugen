...
test('accepts production promotion and rollback events', () => {
  for (const type of ['PRODUCTION_PROMOTION','PRODUCTION_ROLLBACK']) {
    const r = validateLearningEvent({ ...base, type });
