...
} from '../scripts/security-operations-proof.mjs';
...
test('DR guard rejects production-like restore targets',()=>{
  ...
  assert.doesNotThrow(()=>assertIsolatedRestoreTarget({targetEnvironment:'dr-ephemeral-20260916', productionProjectRef:'abc'}));
});
