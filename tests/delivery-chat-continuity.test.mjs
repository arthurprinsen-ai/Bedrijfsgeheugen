...
const required = [
  ...
  ['delivery-failure|merge|shared|file-nonoverlap-hidden-semantic-contract-overlap','CHECK_SEMANTIC_CONTRACT_OVERLAP_NOT_ONLY_FILES'],
  ...
  ['delivery-failure|pipeline|shared|independent-repairs-mutually-blocked-ci','CONSOLIDATE_MUTUALLY_DEPENDENT_REPAIRS'],
