-- Security-contract normalization for the atomic obligation CAS function.
-- Preserve atomic CAS behavior while pinning deterministic search_path and explicit fail-closed EXECUTE grants.
