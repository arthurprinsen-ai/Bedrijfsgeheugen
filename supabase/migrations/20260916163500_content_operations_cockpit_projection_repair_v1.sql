-- Forward corrective migration for content_operations_cockpit projection drift.
-- Preserve the existing view column order and append canonical decision lineage.
-- Do not replay the stale #1587 migrations.
