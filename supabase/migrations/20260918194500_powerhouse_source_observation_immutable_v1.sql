...
create or replace function public.powerhouse_source_observation_immutable_v1() returns trigger language plpgsql set search_path='' as $$ begin raise exception 'powerhouse source observations are append-only'; end; $$;
