-- social-publication-authority-v1
create table if not exists public.powerhouse_social_publish_capabilities_v1 (
  ...
  final_media_sha256 text not null default '',
...
alter table public.powerhouse_social_publish_capabilities_v1 enable row level security;
revoke all on table public.powerhouse_social_publish_capabilities_v1 from public, anon, authenticated;
grant select,insert,update on table public.powerhouse_social_publish_capabilities_v1 to service_role;
