...
begin
  ...
  -- BLOCKED/FAILED are diagnostic states and may recover to the last monotonic progress state.
...
-- Seed the complete approved operating horizon idempotently.
select public.sync_content_publication_obligations(date '2026-09-14', date '2026-12-31');

-- Hard invariant: exactly 109 blog obligations for the canonical tenant.
do $$
declare
