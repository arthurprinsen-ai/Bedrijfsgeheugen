...
create index if not exists bg_campaign_links_campaign_key_idx on public.bg_campaign_links(campaign_key);
create index if not exists bg_campaign_links_active_idx on public.bg_campaign_links(status, expires_at);
