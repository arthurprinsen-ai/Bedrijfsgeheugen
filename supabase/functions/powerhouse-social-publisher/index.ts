...
Deno.serve(async (req) => {
  ...
  if (mode === 'audit_only') return json({ ok: true, runDate, provider_reconciliation, buffer_rate_limited: reconciliation.rate_limited, retry_at: reconciliation.retry_at });
