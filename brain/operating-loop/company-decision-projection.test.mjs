...
test('projects one canonical priority portfolio with approvals economics and audit timeline',()=>{
  const records=[
    normalizeBrainRecord({tenantId:'t1',type:'Decision',id:'d-now',subjectId:'process:invoice',owner:'brain',actor:'agent:brain',status:'PROPOSED',expectedValue:30000,costAmount:5000,currency:'EUR',evidenceIds:['e1'],payload:{title:'Automatiseer facturen',portfolioBucket:'NOW',rank:1,score:4.2,reasons:['high_value'],nextAction:'Goedkeuren',confidence:.84}}),
    normalizeBrainRecord({tenantId:'t1',type:'Decision',id:'d-next',subjectId:'data:quality',owner:'brain',actor:'agent:brain',status:'PROPOSED',expectedValue:10000,costAmount:1000,currency:'EUR',evidenceIds:['e2'],payload:{title:'Datakwaliteit verbeteren',portfolioBucket:'NEXT',rank:2,score:2.1,reasons:['dependency'],nextAction:'Onderzoeken',confidence:.75}}),
