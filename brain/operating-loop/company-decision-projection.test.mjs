...
test('projects one canonical priority portfolio with approvals economics and audit timeline',()=>{
  const records=[
    ...
    normalizeBrainRecord({tenantId:'t1',type:'Value',id:'v1',subjectId:'process:invoice',decisionId:'d-now',actionId:'a1',owner:'brain',actor:'agent:brain',status:'REALISED',realizedValue:4000,currency:'EUR',verified:true,executed:true,observedAt:'2026-09-11T08:00:00Z',evidenceIds:['e4']})
  ];
