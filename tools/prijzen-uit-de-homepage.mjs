...
export async function voerPricingShellPipelineUit(stage = 'all') {
  ...
  if (stage === 'all' || stage === 'verify') {
    // Homepage-interacties worden als laatste op de werkelijk gebouwde output gezet,
    // zodat V18/page-policy stappen de event wiring niet opnieuw kunnen verwijderen.
