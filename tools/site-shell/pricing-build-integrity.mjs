...
function ensurePricingRuntime(html, source) {
  ...
  const rescueSrc = '/assets/js/pricing-interactions-rescue-v1.js?v=f7d85cb0d7ba';
...
if (mode === 'capture') {
  ...
  if (!restored.includes('/assets/js/pricing-interactions-rescue-v1.js?v=f7d85cb0d7ba')) {
