...
async function testMobile(browser){
  ...
  await page.close(); return {left:left.split,right:right.split,compact:initial.compact,handleDisplay:initial.handleDisplay};
}
