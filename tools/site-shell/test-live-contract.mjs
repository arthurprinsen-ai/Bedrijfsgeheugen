...
<main data-bg-component="main">inhoud${pricing ? '<section><div class="bg-billing-toggle"><button data-bg-billing="monthly">Maandelijks</button><button data-bg-billing="yearly">Jaarlijks</button><span>2 maanden voordeel</span></div><div data-yearly="€ 14.950"></div><div data-yearly="€ 24.950"></div><div data-yearly="vanaf € 49.950"></div><h3>Build</h3><p>Wat moet het opleveren om zichzelf terug te verdienen?</p></section><section data-bg-component="page-tools"><div class="bgx-vraagbalk"></div><div class="bgx-rekenaar"></div><div class="bgx-rol"></div></section>' : ''}</main>
${extraBeforeFooter}
