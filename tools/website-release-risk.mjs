...
export function classifyWebsiteReleaseRisk({ changedPaths = [], policy = {} } = {}) {
  ...
  if (fullPaths.length > 0) {
    return Object.freeze({
      ...
      requiresTargetedBrowser: false,
      requiresFullBrowser: true,
      matchedPaths: fullPaths,
      affectedRoutes: [],
      reason: 'shared-public-surface-change'
    });
  }
  ...
  if (targetedPaths.length > 0) {
    ...
    return Object.freeze({
      ...
      requiresTargetedBrowser: true,
      requiresFullBrowser: false,
      matchedPaths: targetedPaths,
      affectedRoutes: affectedRoutes.length ? affectedRoutes : ['/'],
      reason: 'page-local-public-surface-change'
    });
  }
