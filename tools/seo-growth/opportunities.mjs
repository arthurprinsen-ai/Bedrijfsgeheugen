...
export function proposeOpportunities(window={},registry={}){
  ...
  // Positie bekend en niet op pagina 1: dan is lage CTR een rangschikkingsprobleem, geen titelprobleem (10 sept 2026, Search Console: /afas-pocket-koppelen pos. 32,6).
  ...
  // Externe zoekmarktsignalen zijn alleen een prioriteringssignaal. Als een intentie al een
  // canonieke money page heeft, verbeteren we die pagina en maken we geen concurrerende blog.
