...
export function applyHomepageScrollStory(html) {
  ...
  // Layout ownership is decided once, during the build. Runtime code may only
  // change state inside this explicit root; it may never discover or promote
  // ancestors based on viewport dimensions.
