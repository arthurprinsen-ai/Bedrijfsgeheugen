...
export function classifyMainWrite({ branch, parentCount, changedPaths, headSha } = {}) {
  ...
  if (parentCount === 1 && materialPaths.length > 0) return { status: 'DIRECT_MAIN_WRITE_INCIDENT', productionGreenAllowed: false, recoveryRequired: true, fingerprint: 'delivery|main-write|material-single-parent-bypass-v1', headSha, materialPaths };
