...
export async function loadDeliveryPreflight({
  ...
  const [lessonsDoc, chatLessonsDoc, continuityDoc, executionLessonsDoc, completenessAddendum, rulesDoc, completenessGuard, browserGuard, ownershipGuard] = await Promise.all([
