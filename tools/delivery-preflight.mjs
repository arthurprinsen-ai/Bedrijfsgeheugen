...
export async function loadDeliveryPreflight({
  ...
  const [lessonsDoc, chatLessonsDoc, continuityDoc, executionLessonsDoc, completenessAddendum, remediationOwnership, rulesDoc, completenessGuard, browserGuard] = await Promise.all([
