...
export async function loadDeliveryPreflight({
  ...
  const [lessonsDoc, chatLessonsDoc, continuityDoc, executionLessonsDoc, completenessAddendum, remediationOwnership, ciEfficiency, rulesDoc, completenessGuard, browserGuard, ownershipGuard] = await Promise.all([
