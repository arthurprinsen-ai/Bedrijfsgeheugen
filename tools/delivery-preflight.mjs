...
export async function loadDeliveryPreflight({
  ...
  const [lessonsDoc, chatLessonsDoc, continuityDoc, executionLessonsDoc, completenessAddendum, controlPlaneLessonsDoc, rulesDoc, completenessGuard, browserGuard] = await Promise.all([
