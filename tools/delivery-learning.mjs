...
export function createPreflightDecision({
  ...
  return Object.freeze({
    ok: true,
    component: normalizedComponent,
    checkedStages: Object.freeze([...stageSet]),
    reusedLessons: Object.freeze(relevant.map(lesson => lesson.fingerprint)),
    appliedPreventionRules: Object.freeze([...applied]),
  });
}
...
export function createObservedFailure({
  ...
  return Object.freeze({
    ...
    reuseBeforeSimilarChange: false,
  });
}
