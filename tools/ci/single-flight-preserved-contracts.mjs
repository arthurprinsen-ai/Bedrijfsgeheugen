...
if (touched('.github/workflows/business-os-experience.yml','.github/workflows/business-os-foundation.yml','.github/workflows/business-os-intelligence.yml','.github/workflows/business-os-migration.yml','.github/workflows/business-os-trust.yml','platform/','portal-next/')) {
...
process.stdout.write(`${JSON.stringify({ ok: true, version: 'single-flight-preserved-contracts-v1', changedCount: changed.length })}\n`);
